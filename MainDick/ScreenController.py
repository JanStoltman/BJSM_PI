...
class ScreenController:
    ...
    def add_spacecraft(self, spacecraft):
        filename = tkinter.PhotoImage(file=spacecraft.image)
        self.spacecraft_bitmap = self.canvas.create_image(spacecraft.position_x, spacecraft.position_y, image=filename)
